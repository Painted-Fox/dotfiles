HyperlinkRegularExpression\((((https%3F|ftp):%5C/%5C/)|www%5C.)(([0-9]+%5C.[0-9]+%5C.[0-9]+%5C.[0-9]+)|localhost|([a-zA-Z0-9%5C-]+%5C.)%2A[a-zA-Z0-9%5C-]+%5C.(com|net|org|info|biz|gov|name|edu|[a-zA-Z][a-zA-Z]))(:[0-9]+)%3F((%5C/|%5C%3F)[^%20"]%2A[^%20,;%5C.:">)])%3F)|(spotify:[^%20]+:[^%20]+)\
...
FontCharSet\0\
FontIsBold\0\
Font\DejaVu%20Sans%20Mono%20for%20Powerline\
TermHeight\25\
TermWidth\100\
WinTitle\\
WinNameAlways\1\
...
HostName\mrwerewolf@mrwerewolf.com\
Present\1\
